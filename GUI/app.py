...
class StateSwitch(ttk.Frame):
    def __init__(self, parent: tk.Misc, title: str, left_label: str, right_label: str, left_command, right_command) -> None:
        ...
        row = ttk.Frame(self, style="Card.TFrame")
        row.pack(anchor="w")
        self.left_button = tk.Button(row, text=left_label, relief="flat", command=left_command, font=("Segoe UI Semibold", 10), pady=10, bd=0, width=11)
        self.left_button.pack(side="left")
        self.right_button = tk.Button(row, text=right_label, relief="flat", command=right_command, font=("Segoe UI Semibold", 10), pady=10, bd=0, width=11)
        self.right_button.pack(side="left", padx=(10, 0))
